	...
	public partial class Service : System.ServiceProcess.ServiceBase {
		...
		private void ThreadServeur(System.Net.Sockets.Socket socServeur) {
			try {
				...
				System.Net.IPEndPoint ipepIPEndPoint = new System.Net.IPEndPoint(System.Net.IPAddress.Any, this.iPort);
				socServeur.Bind(ipepIPEndPoint);
										...
										if(ulLenData != 0) {
											...
											switch(tabData[ulOffsetData + 0]) {
												case 0x00:
													...
													Service.SendInput((uint)piInput.Length, piInput, System.Runtime.InteropServices.Marshal.SizeOf(typeof(Input)));
