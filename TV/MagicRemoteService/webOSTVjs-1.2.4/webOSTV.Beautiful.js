        ...
        m = function() {
            ...
            return n = e, (r = [{
                ...
                value: function(e) {
                    ...
                    var h, y = l({}, s);
                    return this.subscribe = w, this.subscribe && (y.subscribe = this.subscribe), y.subscribe && (this.subscribe = y.subscribe), this.ts = Date.now(), f[this.ts] = this, this.bridge = new PalmServiceBridge, this.bridge.onservicecallback = this.callback.bind(this, c, u, p), this.bridge.call(("/" !== (h = r).slice(-1) && (h += "/"), h + o), JSON.stringify(y)), this
                }
            }, {
                key: "callback",
                value: function() {
                ...
                key: "cancel",
                value: function() {
                    this.cancelled = !0, null !== this.bridge && (this.bridge.cancel(), this.bridge = null), this.ts && f[this.ts] && delete f[this.ts]
                }
            }]) && u(n.prototype, r), t && u(n, t), e
        }(),
        p = {
            request: function() {
        ...
        P = function(e) {
            if (0 === Object.keys(j).length) {
                try {
                    ...
                    j.modelName = n.modelName, j.version = n.platformVersion, j.versionMajor = n.platformVersionMajor, j.versionMinor = n.platformVersionMinor, j.versionDot = n.platformVersionDot, j.sdkVersion = n.platformVersion, j.screenWidth = n.screenWidth, j.screenHeight = n.screenHeight
                } catch (e) {
                    j.modelName = "webOS Device"
                }
                j.screenHeight = j.screenHeight || window.screen.height, j.screenWidth = j.screenWidth || window.screen.width, V.tv && (j.uhd = !1, j.uhd8K = !1, j.hdr10 = !1, j.dolbyVision = !1, j.dolbyAtmos = !1, (new m).send({
                    service: "luna://com.webos.service.config",
                    method: "getConfigs",
                    parameters: {
                        configNames: ["tv.model.modelname", "tv.nyx.platformVersion", "tv.nyx.firmwareVersion", "tv.hw.panelResolution", "tv.hw.displayType", "tv.hw.ddrSize", "tv.model.supportHDR", "tv.config.supportDolbyHDRContents", "tv.config.supportDolbyTVATMOS", "tv.model.supportTemp8K"]
                    },
                    onComplete: function(n) {
                        if (n.configs && (j.modelName = n.configs["tv.model.modelname"] || j.modelName, j.sdkVersion = n.configs["tv.nyx.platformVersion"] || j.sdkVersion, j.uhd = "UD" === n.configs["tv.hw.panelResolution"] || "8K" === n.configs["tv.hw.panelResolution"], j.uhd8K = "8K" === n.configs["tv.hw.panelResolution"] || !0 === n.configs["tv.model.supportTemp8K"], j.oled = "OLED" === n.configs["tv.hw.displayType"], j.ddrSize = n.configs["tv.hw.ddrSize"], j.hdr10 = !0 === n.configs["tv.model.supportHDR"], j.dolbyVision = !0 === n.configs["tv.config.supportDolbyHDRContents"], j.dolbyAtmos = !0 === n.configs["tv.config.supportDolbyTVATMOS"], n.configs["tv.nyx.firmwareVersion"] && "0.0.0" !== n.configs["tv.nyx.firmwareVersion"] || (n.configs["tv.nyx.firmwareVersion"] = n.configs["tv.nyx.platformVersion"]), n.configs["tv.nyx.firmwareVersion"])) {
                            j.version = n.configs["tv.nyx.firmwareVersion"];
                            for (var r = j.version.split("."), t = ["versionMajor", "versionMinor", "versionDot"], o = 0; o < t.length; o += 1) try {
                                j[t[o]] = parseInt(r[o], 10)
                            } catch (e) {
                                j[t[o]] = r[o]
                            }
                        }!n.returnValue || n.missingConfigs ? n.missingConfigs && 1 === n.missingConfigs.length && "tv.model.supportTemp8K" === n.missingConfigs[0] ? e(j) : (new m).send({
                            service: "luna://com.webos.service.tv.systemproperty",
                            method: "getSystemInfo",
                            parameters: {
                                keys: ["firmwareVersion", "modelName", "sdkVersion", "UHD", "OLED", "ddrSize"]
                            },
                            onComplete: function(n) {
                                if (j.modelName = n.modelName || j.modelName, j.sdkVersion = n.sdkVersion || j.sdkVersion, j.uhd = n.UHD ? "true" === n.UHD : j.uhd, j.oled = n.OLED ? "true" === n.OLED : j.oled, j.ddrSize = n.ddrSize || j.ddrSize, n.firmwareVersion && "0.0.0" !== n.firmwareVersion || (n.firmwareVersion = n.sdkVersion), n.firmwareVersion) {
